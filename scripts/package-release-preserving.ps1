...
$requiredPortable = @(
    ...
    "publish\third-party\Tavotto\source\pymupdf-1.28.2.tar.gz",
    "publish\third-party\Tavotto\converter\tavotto-vector-converter.py",
    "publish\third-party\Tavotto\converter\site-packages\pymupdf\_mupdf.pyd",
