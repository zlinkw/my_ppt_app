...
if ((html.match(/data-chart-type=/g) || []).length !== 26) throw new Error("科研绘图工作区必须保留 26 种图表入口。");
...
for (const chartType of ["bar", "groupedBar", "stackedBar", "horizontalBar", "line", "step", "area", "scatter", "bubble", "histogram", "boxplot", "density", "violin", "ecdf", "strip", "regression", "forest", "roc", "precisionRecall", "calibration", "blandAltman", "volcano", "funnel", "heatmap", "donut", "polar"]) {
...
for (const snippet of ["Vega Lite", "26 种图表", "小提琴", "经验累积分布", "森林图", "ROC", "精确率召回", "校准曲线", "Bland", "火山图", "漏斗图", "数据筛选", "保存配置", "下载 SVG", "实时预览", "同一份 SVG", "PowerPoint 2016", "插入 PPT", "不会自动打开浏览器"]) {
